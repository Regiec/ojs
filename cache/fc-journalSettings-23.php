...
dddd
http://uatacz.up.krakow.pl/~wwwaupc/index.php/dddd',
  'proofInstructions' => 
  array (
  ...
  'readerInformation' => 
  array (
    'pl_PL' => 'We encourage readers to sign up for the publishing notification service for this journal. Use the <a href="http://uatacz.up.krakow.pl/~wwwaupc/index.php/dddd/user/register">Register</a> link at the top of the home page for the journal. This registration will result in the reader receiving the Table of Contents by email for each new issue of the journal. This list also allows the journal to claim a certain level of support or readership. See the journal\'s <a href="http://uatacz.up.krakow.pl/~wwwaupc/index.php/dddd/about/submissions#privacyStatement">Privacy Statement</a>, which assures readers that their name and email address will not be used for other purposes.',
  ),
  'authorInformation' => 
  array (
    'pl_PL' => 'Interested in submitting to this journal? We recommend that you review the <a href="http://uatacz.up.krakow.pl/~wwwaupc/index.php/dddd/about">About the Journal</a> page for the journal\'s section policies, as well as the <a href="http://uatacz.up.krakow.pl/~wwwaupc/index.php/dddd/about/submissions#authorGuidelines">Author Guidelines</a>. Authors need to <a href="http://uatacz.up.krakow.pl/~wwwaupc/index.php/dddd/user/register">register</a> with the journal prior to submitting or, if already registered, can simply <a href="http://uatacz.up.krakow.pl/~wwwaupc/index.php/index/login">log in</a> and begin the five-step process.',
  ),
  ...
  array (
    ...
    array (
      ...
      4 => 
      array (
        'content' => 'The text adheres to the stylistic and bibliographic requirements outlined in the <a href="http://uatacz.up.krakow.pl/~wwwaupc/index.php/dddd/about/submissions#authorGuidelines" target="_new">Author Guidelines</a>, which is found in About the Journal.',
        'order' => '5',
      ),
      5 => 
      array (
        'content' => 'If submitting to a peer-reviewed section of the journal, the instructions in <a href="javascript:openHelp(\'http://uatacz.up.krakow.pl/~wwwaupc/index.php/dddd/help/view/editorial/topic/000044\')">Ensuring a Blind Review</a> have been followed.',
        'order' => '6',
      ),
    ),
  ),
