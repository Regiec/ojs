<?php return array (
  'author.submit' => 'Prześlij tekst do opublikowania',
  'author.track' => 'Przesłane teksty',
  'author.competingInterests' => '<a target="_new" class="action" href="{$competingInterestGuidelinesUrl}">Zbieżne zainteresowania</a>',
  'author.submit.submitArticle' => 'Prześlij artykuł',
  ...
  'author.submit.submissionLocale' => 'Język przesyłanego tekstu',
  'author.submit.submissionLocaleDescription' => 'Czasopismo akceptuje teksty napisane w różnych językach. Wybierz w jakim języku został napisany tekst.',
  'author.submit.verifyChecklist' => 'Aby kontynuować, upewnij się, że wszystkie elementy listy zostały zaznaczone.',
  'author.submit.copyrightNoticeAgree' => 'Zapoznałem(am) się z prawami autorskimi dotyczącymi przesyłanego tekstu (ewentualny komenatrz dla redaktora można wpisać poniżej).',
  ...
  'author.submit.form.sectionRequired' => 'Aby kontynuować, upewnij się, że wybrałeś poprawny dział czasopisma dla przesyłanego tekstu.',
  ...
  'author.submit.languageInstructions' => 'Angielski=en; Polski=pl. <a href="http://www.loc.gov/standards/iso639-2/php/code_list.php" target="_blank">Pozostałe kody</a>.',
  ...
  'author.submit.suppFile.createrOrOwner' => 'Autor pliku',
  ...
  'author.submit.confirmationDescription' => 'Aby przesłać tekst do czasopisma {$journalTitle} kliknij Zakończ. Osoba podana jako główny autor tekstu otrzyma e-mail z potwierdzeniem przesłania tekstu. Od tej chwili możliwe jest również śledzenie statusu tekstu po zalogowaniu się na stronie czasopisma {$journalTitle}.',
  ...
  'author.submit.qualifyForWaiver' => 'Proszę o umorzenie płatności za zgłoszenie tekstu.',
  'author.submit.nextSteps' => 'Następne kroki',
  'submission.submit.cancelSubmission' => 'Możesz dokończyć zgłoszenie później. Niekompletne zgłoszenie znajdziesz w swoim panelu roboczym.',
  'submission.submit.coverNote' => 'Wiadomość dla redaktora',
  'submission.submit.privacyStatement' => 'Polityka prywatności czasopisma',
); ?>