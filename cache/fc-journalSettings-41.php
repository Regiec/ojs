...
<a href="{$contextUrl}">{$contextName}</a>',
  ...
  'readerInformation' => 
  array (
    'pl_PL' => 'Zachęcamy czytelników, aby zarejestrowali się na stronie w celu uzyskiwania powiadomień od czasopisma. W tym celu należy kliknąć przycisk <a href="//ojs-test.up.krakow.pl/index.php/e-e/user/register">Zarejestruj</a> znajdujący się w górnej części strony. W wyniku rejestracji czytelnicy będą otrzymywać na skrzynkę e-mail spisy treści nowych numerów. To pozwoli również czasopismu zapewnić dodatkowe wsparcie czytelnikom. Przed rejestracją czytelnicy powinni zapoznać się z <a href="//ojs-test.up.krakow.pl/index.php/e-e/about/submissions#privacyStatement">Polityką prywatności</a>.',
  ),
  'authorInformation' => 
  array (
    'pl_PL' => 'Czy jesteś zaintersowany(a) zgłoszeniem tekstu do tego czasopisma? Rekomendujemy zapoznanie się z zawartością strony <a href="//ojs-test.up.krakow.pl/index.php/e-e/about">O czasopiśmie</a>, na której zamieszczone są zasady czasopisma oraz <a href="//ojs-test.up.krakow.pl/index.php/e-e/about/submissions#authorGuidelines">Instrukcja dla autorów</a>. Autor musi <a href="//ojs-test.up.krakow.pl/index.php/e-e/user/register">zarejestrować się</a> na stronie czasopisma, zanim rozpocznie proces recenzji lub  <a href="//ojs-test.up.krakow.pl/index.php/index/login">zalogować się</a>, jeżeli posiada już konto w systemie. Proces zgłoszenia tekstu składa się z pięciu kroków.',
  ),
