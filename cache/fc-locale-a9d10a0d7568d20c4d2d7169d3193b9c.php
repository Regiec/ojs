<?php return array (
  ...
  'journal.journals' => 'Zeitschriften',
...
<p>Das System konnte die Konfigurationsdatei nicht automatisch überschreiben. Öffnen Sie <tt>config.inc.php</tt> mit einem geeigneten Texteditor und ersetzen Sie den Inhalt durch den Text im nachstehenden Textfeld.</p>',
  ...
  'manager.setup.lockssDescription' => '<strong>Andere LOCKSS-Netzwerke</strong>
<br /><br />
...
Sie können der Nutzerin/dem Nutzer einen Grund für die Sperrung des Zugangs angeben.',
  ...
  'sectionEditor.noneAssigned' => 'Keine redaktionellen Aufgaben zugewiesen',
  ...
  'layoutEditor.noActiveAssignments' => 'Keine redaktionellen Aufgaben zugewiesen',
  ...
  'reviewer.article.selectRecommendation.byEditor' => 'Gutachter/in-Empfehlung setzen oder anpassen',
...
<li>Wenn der Beitrag hochgeladen ist, klicken Sie "Speichern und fortfahren" auf dieser Seite an.</li>
  ...
  'submission.layout.publicGalleyId' => 'Eindeutige Kennung der Fahne',
...
(Weitere Kommentare können nach dem Speichern hinzugefügt werden.)',
  ...
  'search.syntaxInstructions' => '<h4>Suchhinweise: </h4><ul>
...
<li>Verwenden Sie <strong>*</strong> als Platzhalter für beliebige Zeichenfolgen, z.B. <em>Sozi* Moral</em> listet alle Dokumente, die "soziologisch" oder "sozial" enthalten.</li>
  ...
  'about.authorSelfArchive' => 'Selbstarchivierung durch die/den Autor/in',
...
<p>Um mit der Nutzung des Systems zu beginnen, <a href="{$loginUrl}">loggen</a> Sie sich bitte mit dem auf der vorherigen Seite eingegebenen Benutzer/innen-Namen und dem entsprechenden Passwort <a href="{$loginUrl}">ein</a>.</p>
...
<p>Wenn Sie sich noch nicht registriert haben und in Zukunft Neuigkeiten und Hinweise auf Aktualisierungen erhalten möchten, <strong>registrieren Sie sich bitte auf <a href="http://pkp.sfu.ca/ojs/register" target="_new">http://pkp.sfu.ca/ojs/register</a>.</strong> Wenn Sie Fragen oder Kommentare haben, besuchen Sie bitte das <a href="http://forum.pkp.sfu.ca" target="_new">Support-Forum</a>.</p>',
  ...
  'log.review.reviewReinitiated' => 'Durchgang {$round} der Begutachtung von Beitrag {$submissionId} durch {$reviewerName} wurde erneut begonnen.',
  ...
  'rt.admin.settings' => 'Lesewerkzeug-Optionen',
  'rt.admin.settings.description' => 'Die Lesewerkzeuge erscheinen in denjenigen Rubriken der Zeitschrift, die zur Indizierung vorgesehen sind, in Frames neben den Beiträgen. Sie bestehen aus einem Satz optionaler Werkzeuge, die sich auf den jeweiligen Beitrag beziehen und die unten aufgelistet sind, sowie einem Satz von Werkzeugen, die verwandte Themen zugänglich machen, gegliedert nach Bereichen und Fachgebieten.',
  'rt.admin.settings.enableReadingTools' => 'Lesewerkzeuge für die gekennzeichneten Rubriken der Zeitschrift aktivieren.',
  'rt.admin.settings.relatedItems' => 'Verwandte Beiträge',
  'rt.admin.settings.relatedItemsLink' => 'Siehe <a href="{$relatedItemsLink}" class="action">Werkzeuge für Verwandte Beiträge</a> zum Anzeigen, Hinzufügen, Korrigieren oder Entfernen von verwandten Themen für jedes Gebiet.',
  'rt.admin.options' => 'Zeitschriftenwerkzeuge',
  'rt.admin.relatedItems' => 'Werkzeuge für Verwandte Beiträge',
  'rt.admin.settings.addComment' => 'Kommentieren (ermöglicht Leser/innen, Kommentare abzugeben. Die/der Zeitschriftenverwalter/in kann diese Kommentare löschen.)',
  'rt.admin.settings.addComment.authenticated' => 'Benutzer/innen müssen registriert und eingeloggt sein, um kommentieren zu können. Anonymes Kommentieren ist nicht möglich.',
  'rt.admin.settings.addComment.anonymous' => 'Benutzer/innen müssen registriert und eingeloggt sein, um Kommentare abgeben zu können. Anonymes Kommentieren ist möglich.',
  'rt.admin.settings.addComment.unauthenticated' => 'Benutzer/innen müssen nicht registriert sein, um Kommentare abgeben zu können. Anonymes Kommentieren ist möglich.',
  'rt.admin.validateUrls.description' => 'Für Suchmaschinen möglicherweise ungültige URL sind unten aufgeführt.<br />
Dieser Test ist nicht 100% genau, Sie sollten daher jede hier als ungültig gekennzeichneten URL manuell nachprüfen.<br />
Die Prüfung kann bei Such-URLs, die Formularausfüllung verlangen, fehlschlagen.',
  'rt.metadata.dublinCore.primaryAuthor' => 'Autor/in',
  'rt.metadata.pkp.primaryAuthor' => 'Name der Autorin/des Autors, Institution, Land',
  'rt.metadata.pkp.peerReviewed' => 'Begutachter Beitrag',
  'rt.beNotifiedWhen' => 'Benachrichtigung, falls...',
  'rt.thisJournal' => 'Zeitschrift durchsuchen',
  'rt.context.authorTermsDescription' => 'Bei Beiträgen von mehr als einer Autorin/einem Autor lassen Sie für eine Suche nach ähnlichen gemeinsamen Arbeiten dieser Autor/innen alle Namen angekreuzt oder wählen Sie für die Suche nach einzelnen Autor/innen nur jeweils einen Namen aus. Um weitere Informationen zu den durchsuchten Quellen zu erhalten, gehen Sie zu "Über uns". Die Quellen wurden nach ihrer Relevanz und wegen des freien Zugangs zu allen ihren Inhalten bzw. Teilen ihrer Inhalte ausgesucht.',
  ...
  'notification.type.publicationScheduled' => 'Dieser Beitrag wurde zur Publikation vorgesehen.',
