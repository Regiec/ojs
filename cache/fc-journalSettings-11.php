<?php return array (
  ...
  'contactEmail' => 'pstrus@up.krakow.pl',
  'contactFax' => '',
  'contactName' => 'Paweł Struś',
  'contactPhone' => '+48126626262',
  'contributors' => 
  array (
  ),
  'displayCurrentIssue' => true,
  'emailSignature' => '________________________________________________________________________
Wydawnictwa Instytutu Geografii UP
http://uatacz.up.krakow.pl/~wwwaupc/index.php/wigup',
  'envelopeSender' => '',
  'fastTrackFee' => 0,
  'itemsPerPage' => 25,
  'journalTheme' => 'desert',
  ...
  'supportEmail' => 'pstrus@up.krakow.pl',
  'supportName' => 'Paweł Struś',
  'supportPhone' => '+48126626262',
  ...
  'contactAffiliation' => 
  array (
    'pl_PL' => 'Uniwersytet Pedagogiczny w Krakowie, Instytut Geografii',
  ),
  'contactMailingAddress' => 
  array (
    'pl_PL' => '<p>Ul. Podchorążych 2</p><p>30-084 Kraków</p>',
  ),
  'contactTitle' => 
  array (
    'pl_PL' => 'Dr',
...
<li><strong>Final copyedit.</strong> The journal copy editor will verify changes made by the author and incorporate the responses to the author queries to create a final manuscript. When finished, the copy editor will upload the final document through the journal Web site and alert the layout editor to complete formatting.</li>
  ...
  'description' => 
  array (
    'pl_PL' => 'Strona zawiera pełne teksty wydawnictw zwartych przygotowanych przez pracowników Instytutu Geografii Uniwersytetu Pedagogicznego w KrakowieTeksty sa dostepne pod zakładką <a href="/~wwwaupc/index.php/wigup/issue/archive">ARCHIWUM</a>',
  ),
  ...
  'editorialTeam' => 
  array (
    'pl_PL' => '<div id="editorialTeam"><div id="Redaktorzy"><h3>Redaktor</h3><p>dr Sławomir Dorocki, Uniwersytet Pedagogiczny w Krakowie,
Instytut Geografii,
Zakład Przedsiębiorczości i Gospodarki Przestrzennej, Poland</p></div></div>',
  ),
  ...
  'name' => 
  array (
    'pl_PL' => 'Wydawnictwa Instytutu Geografii Uniwersytetu Pedagogicznego w Krakowie',
  ),
  'navItems' => 
  array (
    'pl_PL' => 
  ...
  'publisherNote' => 
  array (
    'pl_PL' => 'Wydawnictwo Uniwersytetu Pedagogicznego w Krakowie',
  ),
  ...
  'searchDescription' => 
  array (
    'pl_PL' => 'Wydawnictwa zwarte Instytutu Geografii, Uniwersytetu Pedagogicznego w Krakowie',
  ),
  'searchKeywords' => 
  array (
    'pl_PL' => 'monografie, geografia, Uniwersytet Pedagogiczny, Kraków',
  ),
  'submissionChecklist' => 
  array (
    'pl_PL' => 
    array (
      ...
      4 => 
      array (
        'content' => 'The text adheres to the stylistic and bibliographic requirements outlined in the <a href="http://uatacz.up.krakow.pl/~wwwaupc/index.php/wigup/about/submissions#authorGuidelines" target="_new">Author Guidelines</a>, which is found in About the Journal.',
        'order' => '5',
      ),
      5 => 
      array (
        'content' => 'If submitting to a peer-reviewed section of the journal, the instructions in <a href="javascript:openHelp(\'http://uatacz.up.krakow.pl/~wwwaupc/index.php/wigup/help/view/editorial/topic/000044\')">Ensuring a Blind Review</a> have been followed.',
        'order' => '6',
      ),
    ),
  ),
