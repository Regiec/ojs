...
function content_5e2041ffd1e5b2_39570443 (Smarty_Internal_Template $_smarty_tpl) {
?><div id="articlesBySameAuthorList">
	<?php if ($_smarty_tpl->tpl_vars['noMetricSelected']->value) {?>
		<h2 class="article-section-title article-bysameauthor"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('key'=>"plugins.generic.recommendByAuthor.heading"),$_smarty_tpl ) );?>
</h2>
...
while ($_block_repeat) {
ob_start();?>
					<?php $_smarty_tpl->_assignInScope('publishedArticle', $_smarty_tpl->tpl_vars['articleBySameAuthor']->value['publishedArticle']);?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
						<a href="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('journal'=>$_smarty_tpl->tpl_vars['journal']->value->getPath(),'page'=>"article",'op'=>"view",'path'=>$_smarty_tpl->tpl_vars['publishedArticle']->value->getBestArticleId()),$_smarty_tpl ) );?>
">
