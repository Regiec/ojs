...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5e2042438fbda3_72855301',
...
function content_5e2042438fbda3_72855301 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
 ...
 <?php echo mb_strtolower($_smarty_tpl->tpl_vars['navigationMenuItemAssignment']->value->navigationMenuItem->getType(), 'UTF-8');
...
"
					class="nav-link<?php if ($_smarty_tpl->tpl_vars['hasChildren']->value) {?> dropdown-toggle<?php }?>"
					<?php if ($_smarty_tpl->tpl_vars['hasChildren']->value) {?>
						id="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'concat' ][ 0 ], array( 'navMenuDropdown',$_smarty_tpl->tpl_vars['field']->value ));?>
"
				...
				<?php if ($_smarty_tpl->tpl_vars['hasChildren']->value) {?>
					<div class="dropdown-menu<?php if ($_smarty_tpl->tpl_vars['id']->value === 'userNav') {?> dropdown-menu-right<?php }?>" aria-labelledby="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'concat' ][ 0 ], array( 'navMenuDropdown',$_smarty_tpl->tpl_vars['field']->value ));?>
">
						<?php
