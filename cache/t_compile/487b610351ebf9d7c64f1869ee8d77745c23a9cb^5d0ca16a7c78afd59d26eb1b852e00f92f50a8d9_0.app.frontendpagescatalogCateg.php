<?php
/* Smarty version 3.1.33, created on 2020-01-16 12:29:27
  from 'app:frontendpagescatalogCateg' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5e2057274415e9_06084301',
...
function content_5e2057274415e9_06084301 (Smarty_Internal_Template $_smarty_tpl) {
...
if ($_smarty_tpl->tpl_vars['description']->value) {?> has_description<?php }?>">
		<?php if ($_smarty_tpl->tpl_vars['image']->value) {?>
			<div class="cover" href="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('router'=>@constant('ROUTE_PAGE'),'page'=>"catalog",'op'=>"fullSize",'type'=>"category",'id'=>$_smarty_tpl->tpl_vars['category']->value->getId()),$_smarty_tpl ) );?>
">
				<img src="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('router'=>@constant('ROUTE_PAGE'),'page'=>"catalog",'op'=>"thumbnail",'type'=>"category",'id'=>$_smarty_tpl->tpl_vars['category']->value->getId()),$_smarty_tpl ) );?>
" alt="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['category']->value->getLocalizedTitle() ));?>
" />
			</div>
		<?php }?>
	...
	<?php if (!$_smarty_tpl->tpl_vars['subcategories']->value->wasEmpty()) {?>
...
$_smarty_tpl->smarty->_cache['_tag_stack'][] = array('iterate', array('from'=>'subcategories','item'=>'subcategory'));
$_block_repeat=true;
echo $_block_plugin1->smartyIterate(array('from'=>'subcategories','item'=>'subcategory'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
				<li>
...
echo $_block_plugin1->smartyIterate(array('from'=>'subcategories','item'=>'subcategory'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
...
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('router'=>@constant('ROUTE_PAGE'),'page'=>"catalog",'op'=>"category",'path'=>call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'to_array' ][ 0 ], array( $_smarty_tpl->tpl_vars['category']->value->getPath(),$_smarty_tpl->tpl_vars['prevPage']->value ))),$_smarty_tpl ) );
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);?>
		<?php } elseif ($_smarty_tpl->tpl_vars['prevPage']->value === 1) {?>
			<?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, 'default', 'prevUrl', null);
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('router'=>@constant('ROUTE_PAGE'),'page'=>"catalog",'op'=>"category",'path'=>$_smarty_tpl->tpl_vars['category']->value->getPath()),$_smarty_tpl ) );
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);?>
		<?php }?>
		<?php if ($_smarty_tpl->tpl_vars['nextPage']->value) {?>
			<?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, 'default', 'nextUrl', null);
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('router'=>@constant('ROUTE_PAGE'),'page'=>"catalog",'op'=>"category",'path'=>call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'to_array' ][ 0 ], array( $_smarty_tpl->tpl_vars['category']->value->getPath(),$_smarty_tpl->tpl_vars['nextPage']->value ))),$_smarty_tpl ) );
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);?>
		<?php }?>
