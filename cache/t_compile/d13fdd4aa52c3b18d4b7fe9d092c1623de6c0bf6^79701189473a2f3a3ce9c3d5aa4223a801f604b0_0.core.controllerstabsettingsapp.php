...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5e20441e8aff56_20831323',
...
function content_5e20441e8aff56_20831323 (Smarty_Internal_Template $_smarty_tpl) {
$_block_plugin18 = isset($_smarty_tpl->smarty->registered_plugins['block']['fbvFormArea'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['fbvFormArea'][0][0] : null;
...
$_block_repeat=true;
echo $_block_plugin18->smartyFBVFormArea(array('id'=>"pageFooterContainer",'title'=>"manager.setup.pageFooter"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_block_repeat=true;
echo $_block_plugin19->smartyFBVFormSection(array('description'=>"manager.setup.pageFooterDescription"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
echo $_block_plugin19->smartyFBVFormSection(array('description'=>"manager.setup.pageFooterDescription"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
$_block_repeat=false;
echo $_block_plugin18->smartyFBVFormArea(array('id'=>"pageFooterContainer",'title'=>"manager.setup.pageFooter"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
}
}
