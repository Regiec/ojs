<?php
/* Smarty version 3.1.33, created on 2020-01-16 22:30:01
  from 'app:frontendpagesuserRegister' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5e20e3e9a94ca7_04329048',
...
function content_5e20e3e9a94ca7_04329048 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
                    <?php if (in_array($_smarty_tpl->tpl_vars['userGroup']->value->getId(),$_smarty_tpl->tpl_vars['userGroupIds']->value)) {?>
						...
						<input type="hidden" name="readerGroup[<?php echo $_smarty_tpl->tpl_vars['userGroupId']->value;?>
]" value="1">
                    <?php }?>
                <?php
}
...
?>
                    <?php if (in_array($_smarty_tpl->tpl_vars['userGroup']->value->getId(),$_smarty_tpl->tpl_vars['userGroupIds']->value)) {?>
                        <?php $_smarty_tpl->_assignInScope('userGroupId', $_smarty_tpl->tpl_vars['userGroup']->value->getId());?>
						<input type="hidden" name="authorGroup[<?php echo $_smarty_tpl->tpl_vars['userGroupId']->value;?>
]" value="1">
                    <?php }?>
                <?php
}
...
?>
			...
			<div class="register-form-buttons btn-group" role="group">
				<button type="submit" class="submit btn btn-secondary"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('key'=>"user.register"),$_smarty_tpl ) );?>
</button>
...
" type="button" class="login btn btn-secondary">
