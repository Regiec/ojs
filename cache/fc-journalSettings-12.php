<?php return array (
  ...
  'contactEmail' => 'aapcsp@gmail.com',
  'contactFax' => '',
  'contactName' => 'Karolina Pietras',
  'contactPhone' => '',
  'contributors' => 
  array (
  ),
...
http://uatacz.up.krakow.pl/~wwwaupc/index.php/aupcsp',
  ...
  'mailingAddress' => 'Annales Universitatis Paedagogicae Cracoviensis. Studia Psychologica
Pedagogical University
4 Podchorążych Street 
Kraków 30-084  
Poland',
  ...
  'publisherInstitution' => 'Pedagogical University',
  'publisherUrl' => 'http://www.wydawnictwoup.pl',
  'publishingMode' => 0,
  ...
  'supportEmail' => 'tsmolen@up.krakow.pl',
  'supportName' => 'Tomasz Smolen',
  'supportPhone' => '',
  'themePluginPath' => 'oldGregg',
  ...
  array (
    'en_US' => '
							...
							<p>This journal provides immediate open access to its content on the principle that making research freely available to the public supports a greater global exchange of knowledge.</p>
								...
								<p>Annales Universitatis Paedagogicae Cracoviensis Studia Psychologica was formerly printed as Annales Academiae Paedagogicae Cracoviensis Studia Psychologica</p>
								</div>',
  ),
  'acronym' => 
  array (
  ...
  'authorInformation' => 
  array (
    'en_US' => 'Interested in submitting to this journal? We recommend that you review the <a href="/~wwwaupc/index.php/aupcsp/about">About the Journal</a> page for the journal\'s section policies, as well as the <a href="/~wwwaupc/index.php/aupcsp/about/submissions#authorGuidelines">Author Guidelines</a>. Authors need to <a href="/~wwwaupc/index.php/aupcsp/user/register">register</a> with the journal prior to submitting or, if already registered, can simply <a href="/~wwwaupc/index.php/index/login">log in</a> and begin the five-step process.',
    'pl_PL' => 'Interested in submitting to this journal? We recommend that you review the <a href="http://uatacz.up.krakow.pl/~wwwaupc/index.php/aupcsp/about">About the Journal</a> page for the journal\'s section policies, as well as the <a href="http://uatacz.up.krakow.pl/~wwwaupc/index.php/aupcsp/about/submissions#authorGuidelines">Author Guidelines</a>. Authors need to <a href="http://uatacz.up.krakow.pl/~wwwaupc/index.php/aupcsp/user/register">register</a> with the journal prior to submitting or, if already registered, can simply <a href="http://uatacz.up.krakow.pl/~wwwaupc/index.php/index/login">log in</a> and begin the five-step process.',
  ),
  ...
  'contactAffiliation' => 
  array (
    'en_US' => 'Pedagogical University',
  ),
  'contactTitle' => 
  array (
    'en_US' => 'Scientific Secretary',
  ),
...
<li><strong>Final copyedit.</strong> The journal copy editor will verify changes made by the author and incorporate the responses to the author queries to create a final manuscript. When finished, the copy editor will upload the final document through the journal Web site and alert the layout editor to complete formatting.</li>
  ...
  'editorialTeam' => 
  array (
    'en_US' => '<div id="editorialTeam"><div id="Editors"><h3>Editors</h3><p>Tomasz Smoleń</p><p>Karolina Pietras</p><p>dr Joanna Monika Kossewska, Pedagogical University, Poland</p><p>Michał Gacek, Uniwersytet Pedagogiczny im. KEN w Krakowie</p><p>Aleksandra Anna Dembińska, Uniwersytet Pedagogiczny w Krakowie, Poland</p></div></div>',
  ),
  ...
  'history' => 
  array (
    'en_US' => 'Annales Universitatis Paedagogicae Cracoviensis Studia Psychologica was formerly printed as Annales Academiae Paedagogicae Cracoviensis Studia Psychologica',
  ),
  'homepageImage' => 
  array (
    'en_US' => 
    array (
      'name' => 'pageHeaderTitleImage_pl_PL.jpg',
      'uploadName' => 'homepageImage_en_US.jpg',
      'width' => 1920,
      'height' => 300,
      'dateUploaded' => '2019-12-19 07:10:33',
      'altText' => '',
    ),
  ),
  ...
  'name' => 
  array (
    'en_US' => 'Annales Universitatis Paedagogicae Cracoviensis Studia Psychologica',
    'pl_PL' => 'Annales Universitatis Paedagogicae Cracoviensis Studia Psychologica',
  ),
  'openAccessPolicy' => 
  array (
  ...
  array (
    ...
    'pl_PL' => '<p>The names and email addresses entered in this journal site will be used exclusively for the stated purposes of this journal and will not be made available for any other purpose or to any other party.</p>',
  ),
  'proofInstructions' => 
  array (
  ...
  'publisherNote' => 
  array (
    'en_US' => 'Pedagogical University in Krakow Publishing House',
  ),
  ...
  'readerInformation' => 
  array (
    'en_US' => 'We encourage readers to sign up for the publishing notification service for this journal. Use the <a href="/~wwwaupc/index.php/aupcsp/user/register">Register</a> link at the top of the home page for the journal. This registration will result in the reader receiving the Table of Contents by email for each new issue of the journal. This list also allows the journal to claim a certain level of support or readership. See the journal\'s <a href="/~wwwaupc/index.php/aupcsp/about/submissions#privacyStatement">Privacy Statement</a>, which assures readers that their name and email address will not be used for other purposes.',
    'pl_PL' => 'We encourage readers to sign up for the publishing notification service for this journal. Use the <a href="http://uatacz.up.krakow.pl/~wwwaupc/index.php/aupcsp/user/register">Register</a> link at the top of the home page for the journal. This registration will result in the reader receiving the Table of Contents by email for each new issue of the journal. This list also allows the journal to claim a certain level of support or readership. See the journal\'s <a href="http://uatacz.up.krakow.pl/~wwwaupc/index.php/aupcsp/about/submissions#privacyStatement">Privacy Statement</a>, which assures readers that their name and email address will not be used for other purposes.',
  ),
  'refLinkInstructions' => 
  array (
  ...
  'searchKeywords' => 
  array (
    'en_US' => 'Psychology; Journal; Krakow',
  ),
  'submissionChecklist' => 
  array (
    'en_US' => 
    array (
      ...
      array (
        'order' => '5',
        'content' => 'The text adheres to the stylistic and bibliographic requirements outlined in the <a href="/~wwwaupc/index.php/aupcsp/about/submissions#authorGuidelines" target="_new">Author Guidelines</a>, which is found in About the Journal.',
      ),
      5 => 
      array (
        'order' => '6',
        'content' => 'If submitting to a peer-reviewed section of the journal, the instructions in <a href="javascript:openHelp(\'http://uatacz.up.krakow.pl/~wwwaupc/index.php/aupcsp/help/view/editorial/topic/000044\')">Ensuring a Blind Review</a> have been followed.',
      ),
    ),
    'pl_PL' => 
    array (
      ...
      4 => 
      array (
        'content' => 'The text adheres to the stylistic and bibliographic requirements outlined in the <a href="http://uatacz.up.krakow.pl/~wwwaupc/index.php/aupcsp/about/submissions#authorGuidelines" target="_new">Author Guidelines</a>, which is found in About the Journal.',
        'order' => '5',
      ),
      5 => 
      array (
  ...
  array (
    'pl_PL' => 
    array (
      'name' => 'picture_2017_40861.jpg',
      'uploadName' => 'favicon_pl_PL.jpg',
      'width' => 2008,
      'height' => 2835,
      'dateUploaded' => '2019-07-05 10:39:00',
      'altText' => '',
    ),
  ),
  'journalThumbnail' => 
  array (
    'pl_PL' => 
    array (
      'name' => 'journalThumbnail_pl_PL (13).jpg',
      'uploadName' => 'journalThumbnail_pl_PL.jpg',
      'width' => 220,
      'height' => 310,
      'dateUploaded' => '2019-12-11 08:33:34',
      'altText' => '',
    ),
  ),
); ?>