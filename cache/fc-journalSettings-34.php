<?php return array (
  ...
  'name' => 
  array (
    'en_US' => 'Annales Universitatis Paedagogicae Cracoviensis Studia Mediterranea The Journal for Research and Studies',
    'pl_PL' => 'Annales Universitatis Paedagogicae Cracoviensis Studia Mediterranea The Journal for Research and Studies',
  ),
  'acronym' => 
  array (
    'en_US' => 'AUPC SMJRS',
  ...
  'printIssn' => '',
  'onlineIssn' => '',
  'mailingAddress' => '<p>Annales Universitatis Paedagogicae Cracoviensis Studia Mediterranea, The Journal for Research and Studies.  <br />The International Center for Research and Studies <em>Mediterraneum</em>, Institute of Political Science, Pedagogical University of Cracow.</p><p>ul. Podchorążych 2, p.446 <br />30-084 Kraków,<br />tel. (+48 12) 662-62-10</p><p>e-mail: mediterraneum@up.krakow.pl</p>',
  'useEditorialBoard' => false,
  'contactName' => 'Stefan Bielański',
  'contactTitle' => 
  array (
    'en_US' => 'dr hab. prof. UP',
  ),
  'contactAffiliation' => 
  array (
    'en_US' => 'Institute of Political Science',
  ),
  'contactEmail' => 'mediterraneum@up.krakow.pl',
  'numPageLinks' => 10,
  'itemsPerPage' => 25,
  'privacyStatement' => 
  array (
  ...
  'readerInformation' => 
  array (
    'pl_PL' => 'We encourage readers to sign up for the publishing notification service for this journal. Use the <a href="http://aupc.up.krakow.pl/index.php/sm/user/register">Register</a> link at the top of the home page for the journal. This registration will result in the reader receiving the Table of Contents by email for each new issue of the journal. This list also allows the journal to claim a certain level of support or readership. See the journal\'s <a href="http://aupc.up.krakow.pl/index.php/sm/about/submissions#privacyStatement">Privacy Statement</a>, which assures readers that their name and email address will not be used for other purposes.',
    'en_US' => 'We encourage readers to sign up for the publishing notification service for this journal. Use the <a href="/index.php/sm/user/register">Register</a> link at the top of the home page for the journal. This registration will result in the reader receiving the Table of Contents by email for each new issue of the journal. This list also allows the journal to claim a certain level of support or readership. See the journal\'s <a href="/index.php/sm/about/submissions#privacyStatement">Privacy Statement</a>, which assures readers that their name and email address will not be used for other purposes.',
  ),
  'authorInformation' => 
  array (
    'pl_PL' => 'Interested in submitting to this journal? We recommend that you review the <a href="http://aupc.up.krakow.pl/index.php/sm/about">About the Journal</a> page for the journal\'s section policies, as well as the <a href="http://aupc.up.krakow.pl/index.php/sm/about/submissions#authorGuidelines">Author Guidelines</a>. Authors need to <a href="http://aupc.up.krakow.pl/index.php/sm/user/register">register</a> with the journal prior to submitting or, if already registered, can simply <a href="http://aupc.up.krakow.pl/index.php/index/login">log in</a> and begin the five-step process.',
    'en_US' => 'Interested in submitting to this journal? We recommend that you review the <a href="/index.php/sm/about">About the Journal</a> page for the journal\'s section policies, as well as the <a href="/index.php/sm/about/submissions#authorGuidelines">Author Guidelines</a>. Authors need to <a href="/index.php/sm/user/register">register</a> with the journal prior to submitting or, if already registered, can simply <a href="/index.php/index/login">log in</a> and begin the five-step process.',
  ),
  ...
  array (
    ...
    array (
      ...
      4 => 
      array (
        'content' => 'The text adheres to the stylistic and bibliographic requirements outlined in the <a href="http://aupc.up.krakow.pl/index.php/sm/about/submissions#authorGuidelines" target="_new">Author Guidelines</a>, which is found in About the Journal.',
        'order' => '5',
      ),
      5 => 
      array (
        'content' => 'If submitting to a peer-reviewed section of the journal, the instructions in <a href="javascript:openHelp(\'http://aupc.up.krakow.pl/index.php/sm/help/view/editorial/topic/000044\')">Ensuring a Blind Review</a> have been followed.',
        'order' => '6',
      ),
    ),
    'en_US' => 
    array (
      ...
      array (
        'order' => '5',
        'content' => 'The text adheres to the stylistic and bibliographic requirements outlined in the <a href="/index.php/sm/about/submissions#authorGuidelines" target="_new">Author Guidelines</a>, which is found in About the Journal.',
      ),
      5 => 
      array (
        'order' => '6',
...
<li><strong>Final copyedit.</strong> The journal copy editor will verify changes made by the author and incorporate the responses to the author queries to create a final manuscript. When finished, the copy editor will upload the final document through the journal Web site and alert the layout editor to complete formatting.</li>
  ...
  'copyrightNotice' => 
  array (
    'en_US' => '<p>All articles published by Annales Universitatis Paedagogicae Cracoviensis Studia Mediterranea The Journal for Research and Studies are licensed under the <a href="http://creativecommons.org/licenses/by/4.0/">Creative Commons Attribution 4.0 International License</a>. This permits anyone to copy, redistribute, remix, transmit and adapt the work provided the original work and source is appropriately cited. To view a copy of this license, visit http://creativecommons.org/licenses/by-sa/4.0/ or send a letter to Creative Commons, PO Box 1866, Mountain View, CA 94042, USA.</p>',
  ),
  'history' => 
  array (
    'en_US' => '<p>Annales Universitatis Paedagogicae Cracoviensis Studia Mediterranea The Journal for Research and Studies is a continuation of  biannual <em>MEDITERRANEUM </em>The Journal for Research and Studies published since  2013.</p> In 2015 <em>MEDITERRANEUM </em>The Journal for Research and Studies changed to Annales Universitatis Paedagogicae Cracoviensis Studia Mediterranea The Journal for Research and Studies (AUPC SMJRS)',
  ),
  'pubFreqPolicy' => 
  array (
    'en_US' => 'The journal is published once a year.',
  ),
  'contactPhone' => '(12) 662- 63-23',
  'contactFax' => '',
  'supportName' => 'Karolina Kozub',
  'supportEmail' => 'mediterraneum@up.krakow.pl',
  'supportPhone' => '',
  'sponsors' => 
  array (
  ),
  ...
  'focusScopeDesc' => 
  array (
    'en_US' => '<p>Annales Universitatis Paedagogicae Cracoviensis Studia Mediterranea The Journal for Research and Studies is a scientific, peer-reviewed journal presents original papers, reviews, case reports, reports from conferences, books’ reviews and other articles.</p> <p>The journal covers a broad spectrum of topics in:</p> <ul><li>History of political and legal doctrines, </li><li>History of State and Law, </li><li>International Relations, </li><li>International law </li><li>Constitutional Law.</li></ul> <p>with particular focusing on:</p> <ul><li>Italian political thought in the modern and contemporary era</li><li>Regionalism and federalism in the history of political thought Italy and Spain </li><li>The civilization of the Mediterranean (with particular emphasis on areas of the Apennine Peninsula, the Mediterranean coast of France and the Iberian Peninsula) in the  modern and contemporary era; </li><li>Fascism and the Holocaust.</li></ul>',
  ),
...
http://aupc.up.krakow.pl/index.php/sm',
  'about' => 
  array (
    'en_US' => '
							<div id="focusAndScope">
							<h3>Focus and Scope</h3>
							<p><p>Annales Universitatis Paedagogicae Cracoviensis Studia Mediterranea The Journal for Research and Studies is a scientific, peer-reviewed journal presents original papers, reviews, case reports, reports from conferences, books’ reviews and other articles.</p> <p>The journal covers a broad spectrum of topics in:</p> <ul><li>History of political and legal doctrines, </li><li>History of State and Law, </li><li>International Relations, </li><li>International law </li><li>Constitutional Law.</li></ul> <p>with particular focusing on:</p> <ul><li>Italian political thought in the modern and contemporary era</li><li>Regionalism and federalism in the history of political thought Italy and Spain </li><li>The civilization of the Mediterranean (with particular emphasis on areas of the Apennine Peninsula, the Mediterranean coast of France and the Iberian Peninsula) in the  modern and contemporary era; </li><li>Fascism and the Holocaust.</li></ul></p>
							</div>
  ...
  'editorialTeam' => 
  array (
    'en_US' => '<div id="group"><h4>Managing Editor</h4><p>Karolina Kozub</p></div>',
  ),
