...
<body class="pkp_page_{$requestedPage|escape|default:"index"} pkp_op_{$requestedOp|escape|default:"index"}{if $showingLogo} has_site_logo{/if}">
	<div class="pkp_structure_page">
		...
		<div>
		<a href="https://ojs-test.up.krakow.pl/index.php/studpoet"><img class="img-responsive" src="https://ojs-test.up.krakow.pl/public/journals/21/homepageImage_pl_PL.png" alt="{$homepageImageAltText|escape}"></a>
		</div>
